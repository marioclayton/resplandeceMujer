    ...
    <main>
      <section className="bg-[#3c211b] px-[5%] pb-24 pt-40 text-[#fff8ef] md:pb-32 md:pt-48">
        <div className="container grid items-end gap-12 md:grid-cols-[1.1fr_.9fr]">
          <div><p className="eyebrow text-[#e2ad94]">Acerca de este espacio</p><h1 className="mt-5 text-5xl leading-[.98] text-[#fff8ef] md:text-7xl">Una invitación a vivir desde adentro hacia afuera</h1></div>
