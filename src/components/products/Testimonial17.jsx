      ...
      <div className="container">
        <div className="mx-auto mb-12 w-full max-w-lg text-center md:mb-18 lg:mb-20">
          ...
          <p className="md:text-md">
            Descubre cómo nuestros productos han transformado vidas.
          </p>
        </div>
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "Estos productos han sido una bendición en mi vida."
              </blockquote>
            </div>
          ...
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "No puedo imaginar mi vida sin estos productos."
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
          ...
          <Card className="flex w-full flex-col items-start justify-between p-6 md:p-8">
            <div className="rb-5 mb-5 md:mb-6">
              ...
              <blockquote className="md:text-md">
                "Cada artículo refleja mi fe y estilo personal."
              </blockquote>
            </div>
            <div className="mt-5 flex w-full flex-col items-start md:mt-6 md:w-fit md:flex-row md:items-center">
              <img
              ...
              />
              <div>
                <p className="font-semibold">Claudia Ruiz</p>
                <p>Bloguera cristiana</p>
              </div>
            </div>
          </Card>
        </div>
