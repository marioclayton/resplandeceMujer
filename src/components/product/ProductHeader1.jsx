...
export function ProductHeader1({ product }) {
  ...
  return <header className="bg-[#f8f2e9] px-[5%] pb-20 pt-36 md:pb-28 md:pt-44"><div className="container"><div className="grid items-start gap-10 lg:grid-cols-[.9fr_1.1fr] lg:gap-x-20">
    ...
    <div className="pt-2"><p className="eyebrow mb-5 text-[#9b5b47]">{productCategory || "Recurso para tu camino"}</p><h1 className="max-w-2xl text-[clamp(2.6rem,5vw,4.5rem)] font-normal leading-[1.04] tracking-[-.025em] text-[#2f211d]">{productName}</h1><p className="mt-6 text-xl font-semibold text-[#7d4032] md:text-2xl">{isFreePdf ? "Gratis" : `$${price || "0"}`}</p>
